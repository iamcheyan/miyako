...
interface RadioPodcastVisualProps {
  isPlaying: boolean;
}

function RadioPodcastVisual({ isPlaying }: RadioPodcastVisualProps) {
  return (
    <div className={`microphone-container ${isPlaying ? "broadcasting" : ""}`}>
      ...
      <div className="microphone-body">
        ...
        >
          ...
          />
          <path
            d="M52.25 89.42l6.49 12.64l2.43-1.62l-7.62-14.59c.01 0-.79 2.55-1.3 3.57z"
            fill="#ee3e23"
          />
          ...
          <path
            d="M64.2 45.81l6.06.06l.4 3.97c.19 1.82.51 4.4.51 4.4l-6.92.04l-.05-8.47z"
            fill="#c9c7ca"
          />
          <path
            d="M64.37 62.93s11.66-.03 12.8-.03c1.17 0 1.68.69 1.3 1.56c-.38.86-3.38 5.18-3.83 5.94c-.13.22-10.19.25-10.19.25l-.08-7.72z"
            fill="#afb1b0"
          />
        </svg>
      </div>
...
export default memo(RadioPodcastVisual);